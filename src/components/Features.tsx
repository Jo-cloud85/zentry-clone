...
/*
The title prop is accepting a JSX element (React node) since it contains HTML-like elements (<b>) and fragments (<>).
React.ReactNode is the most inclusive type that can handle any valid React child content.
*/
...
const Features = () => {
  return (
    <section className="bg-black pb-52">
      ...
      <div className="sm:mx-auto md:mx-32">
